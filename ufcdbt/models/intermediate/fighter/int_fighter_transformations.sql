SELECT 
  ...
  COALESCE(b.ufc_win_percentage_by_sub, 0) AS "ufc_win_percentage_by_sub",
  COALESCE(b.ufc_wins_by_dec, 0) AS "ufc_wins_by_dec",
  COALESCE(b.ufc_win_percentage_by_dec, 0) AS "ufc_win_percentage_by_dec",
  COALESCE(l.ufc_losses_by_ko_tko, 0) AS "ufc_losses_by_ko_tko",
  COALESCE(l.ufc_loss_percentage_by_ko_tko, 0) AS "ufc_loss_percentage_by_ko_tko",
  COALESCE(l.ufc_losses_by_sub, 0) AS "ufc_losses_by_sub",
  COALESCE(l.ufc_loss_percentage_by_sub, 0) AS "ufc_loss_percentage_by_sub",
  COALESCE(l.ufc_losses_by_dec, 0) AS "ufc_losses_by_dec",
  COALESCE(l.ufc_loss_percentage_by_dec, 0) AS "ufc_loss_percentage_by_dec",
