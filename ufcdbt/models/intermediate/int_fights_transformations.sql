SELECT
    ...
    rf.age - (EXTRACT(YEAR FROM CURRENT_DATE) - EXTRACT(YEAR FROM f.fight_date)) AS "r_age",
    f.r_fighter_status,
    f.b_fighter_id,
    bf.full_name AS b_fighter_name, 
    bf.age - (EXTRACT(YEAR FROM CURRENT_DATE) - EXTRACT(YEAR FROM f.fight_date)) AS "b_age",
    f.b_fighter_status,
    f.fight_order,
    f.ending_round,
    f.time,
